![Milan](img/Milan.jpg){ align=left width="70" height="100"}
&nbsp;&nbsp;&nbsp; Hello! My name is Milan Hronský  
&nbsp;&nbsp;&nbsp; I am a teacher of electrical engineering, researching the propagation of stochastic  
&nbsp;&nbsp;&nbsp; signals in linear systems. My current research aims to better integrate  
&nbsp;&nbsp;&nbsp; the renewable energy sources (RES) into the electricity grid.  
...
A lossless filter of intermittent power, accumulating a minimum of energy, is discussed here in theory and practise. Its energy storage system (ESS) has been mimized in terms of energy capacity, and it can provide [synthetic inertia](https://mhrons.github.io/pv_intermit/#smoothing-synthetic-inertia) to the grid on days with low solar/wind intermittency, as a by-product.  
...
![PV Panels](img/PV_Panels.JPG){ align=left width="120"}  
[PV Logger](https://mhrons.github.io/pv_log/)  
<br>  
<br>
![GI Smoothing](img/GI_PV2.3but7.5.2022-04-04.png){ align=left width="120"}  
[Smoothing Renewable Power](https://mhrons.github.io/pv_smooth/)  
<br>  
<br>  
