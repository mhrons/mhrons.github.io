...
The rate of accumulation is expressed by (4) and (5) which are minimized by Δt during a working cycle T (24 hours in case of PV energy). The rate of accumulation is also expressed by the extreme BESS power demand p(τ)-s(τ+Δt) during a sudden loss or peak of direct sunlight. This value results from the installed power of PVPP.
