...
The rate of accumulation is expressed by (4) and (5) which are minimized by Δt during a working cycle T = 24 hours (in case of PV energy). The rate of accumulation is also expressed by the battery power demand during a sudden loss of direct sunlight. This results from the installed power of PVPP.
