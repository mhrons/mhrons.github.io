...
**We will focus our analyis on the application of a 
...
- Eventually, a novel smoothing method **SPLPF** has been designed, exciting the filter by the PV predictor, though using another scheme.
