...
The ideal predictive smoothing (IPLPF) is simulated by means of a LPF, ex-post excited by the future signal GI(t+Δt) where GI(t) is measured and the lead time interval Δt eliminates the LPF’s time lag. Our numeric experiment is based on the measured solar irradiance over a period of 1+ year.  
...
IPLPF smoothing of the wind turbine power exhibits a similar specific accumulation rate to that of the PV power smoothing. The wind power has similar intermittency like the PV power, except its weak and random low-spectral component. (Daily cycles exhibit a relatively weak influence on wind.)  
